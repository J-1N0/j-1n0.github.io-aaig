...
function aade(){
			...
			for(var i in files){
				...
				for(var sectionNumber in sections){
					...
					for(var j = 0; j < section.length; j++){
						...
						var checkCharacterAlphanumeric = /^[a-zA-Z0-9ÀÁÃÂÇÉÊÍÏÓÔÕÚÜÑĈĜĤĴŜŬàáãâçéêíïóôõúüñĉĝĥĵŝŭ().]*$/.test(char);
	...
	this.formatChar = function(char){
		var charTable = {
			...
			'Ñ': 'N-tilde', 'Ÿ': 'Y-diaeresis', 'Ĉ': 'C-circumflex', 'Ĝ': 'G-circumflex',
			'Ĥ': 'H-circumflex', 'Ĵ': 'J-circumflex', 'Ŝ': 'S-circumflex', 'Ŭ': 'U-crescent',
			// Lowercase accents
			'à': 'a-grave', 'á': 'a-acute', 'â': 'a-circumflex', 'ã': 'a-tilde',
			'ä': 'a-diaeresis', 'ç': 'c-cedilla', 'è': 'e-grave', 'é': 'e-acute', 
