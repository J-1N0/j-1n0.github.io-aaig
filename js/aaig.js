		...
		$('input.slider').each(function(){
			...
			if($input.hasClass('scale')){
				...
				$input.on('change', function(){
					...
					if(($.inArray(game, ['aa123_ds', 'aa4_ds', 'aai_ds','aai2_ds']) !== -1) && ($.inArray(previewConteinerFieldId, ['proof-profile-title-conteiner', 'proof-profile-subtitle-conteiner', 'proof-profile-description-conteiner', 'logic-title-conteiner', 'logic-description-conteiner']) !== -1)){
	...
	this.updatePreview = function(field, event){
		...
		if($.inArray(previewConteinerFieldId, ['button-conteiner', 'smaller-button-conteiner']) !== -1){
			...
			if(textfieldName == 'proof-profile-title-text-sandbox'){
				...
				if($.inArray(game, ['aa123_ds', 'aa4_ds', 'aai_ds','aai2_ds']) !== -1){
